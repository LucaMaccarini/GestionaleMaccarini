...
<html>
	...
	<body class="sfondo">
		...
		<div class="pos-f-t" style="background:#10ff00b3;">
			<div class="col-md-6 offset-md-3 col-sm-12">
				...
				<nav class="navbar navbar-dark navbar_personalizzata">
					...
					<p class="grassetto" style="color:black;">Fascicolo in entrata</p>
				</nav>
			</div>
		</div>
		...
		<div class="container-fluid corpo_centrale">
			<div class="col-md-6 offset-md-3 col-sm-12">
				<h2 class="title titolo titolo_selezionato">Entrata</h2>
			</div>
			<div class="row">
				<div class="card-header col-12 allineamento_spazzietto_destra_e_sinistra">
				
					<div class="row">
						<div class="card-header	col-md-6 offset-md-3 col-sm-12 form_opzione" id="background_form_aggiungi">
							<form id="la_form" action='../../php/funzioni_post.php' method='post'>
								...
								<input type="hidden" name="_scelta" value="entrata">
							...
							<div class="form-group col-md-8 offset-md-2 div_bottoni_forms">
								...
								<div class="row">
									...
									<button class="btn btn-primary col-5 col-sm-4 offset-2 offset-sm-4 bottone_submit_forms" onclick="controllo_inputs(document.getElementById('numero'),document.getElementById('anno'),document.getElementById('select_modello'),document.getElementById('select_archivio'));">Aggiungi</button>
								</div>
							</div>
